...
// Istanbul + the two Avax opcodes
static const char* avax_names[256] = {
    /* 0x00 */ "STOP",
    /* 0x01 */ "ADD",
    /* 0x02 */ "MUL",
    /* 0x03 */ "SUB",
...
const char* const* evmc_get_instruction_names_table_avax(enum evmc_avax_revision revision)
{
    switch (revision)
    {
    case EVMC_AVAX_ISTANBUL:
    case EVMC_AVAX_APRICOT_1:
    case EVMC_AVAX_APRICOT_2:
    case EVMC_AVAX_APRICOT_3:
    case EVMC_AVAX_APRICOT_4:
    case EVMC_AVAX_APRICOT_5:
    case EVMC_AVAX_APRICOT_6_PRE:
    case EVMC_AVAX_APRICOT_6:
    case EVMC_AVAX_APRICOT_6_POST:
    case EVMC_AVAX_BANFF:
        return avax_names;
    default:
        return NULL;
    }
