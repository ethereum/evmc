...
TEST(mocked_host, storage_update_scenarios)
{
    ...
    EXPECT_EQ(execute_scenario(O, O, O), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(X, O, O), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(O, Y, Y), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(X, Y, Y), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(Y, Y, Y), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(O, Y, Z), EVMC_STORAGE_MODIFIED_AGAIN);
    EXPECT_EQ(execute_scenario(X, Y, Z), EVMC_STORAGE_MODIFIED_AGAIN);
